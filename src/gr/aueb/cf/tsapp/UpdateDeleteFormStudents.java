...
public class UpdateDeleteFormStudents extends JFrame {
	...
	public UpdateDeleteFormStudents() {
		...
		btnFirst_Record.setIcon(new ImageIcon(UpdateDeleteFormStudents.class.getResource("/resources/First record.png")));
		...
		btnPrevious_Record.setIcon(new ImageIcon(UpdateDeleteFormStudents.class.getResource("/resources/Previous_record.png")));
		...
		btnNext_Record.setIcon(new ImageIcon(UpdateDeleteFormStudents.class.getResource("/resources/Next_track.png")));
		...
		btnLast_Record.setIcon(new ImageIcon(UpdateDeleteFormStudents.class.getResource("/resources/Last_Record.png")));
		...
		btnClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Main.getUpdateDeleteFormStudents().setVisible(false);
			}
		});
