	...
	public SearchFormStudents() {
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				Main.getSearchFormStudents().setEnabled(false);
				Main.getUpdateDeleteFormStudents().setVisible(true);	
			}
		});
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Main.getSearchFormStudents().setEnabled(false);
				Main.getInsertFormStudents().setVisible(true);
			}
		});
		...
		btnClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Main.getSearchFormStudents().setVisible(false);
			}
		});
